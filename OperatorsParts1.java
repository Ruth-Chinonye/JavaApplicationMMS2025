public class OperatorsParts1{
	public static void main(String[] args){
		...
		System.out.printf("The diference between %d and %d is %d%n",num1,num2,subtraction);
		
		int multiplication = num1 * num2;
		System.out.printf("The product of %d and %d is %d%n",num1,num2,multiplication);
		
		int quotient = num1/num2;
		System.out.printf("The quotient of %d and %d is %d%n",num1,num2,quotient);
